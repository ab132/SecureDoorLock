...
public class SecureDoorLock {
    ...
    private static List<String> ALLOWED_VISITORS
    ...
    private String getFullName(String firstName, String lastName) {
         ...
         List<String> ALLOWED_VISITORS2 = new ArrayList<String>(ALLOWED_VISITORS);
         ALLOWED_VISITORS2.add(temp);
         System.out.println(ALLOWED_VISITORS2);
         ALLOWED_VISITORS = ALLOWED_VISITORS2;
         System.out.println(ALLOWED_VISITORS);
